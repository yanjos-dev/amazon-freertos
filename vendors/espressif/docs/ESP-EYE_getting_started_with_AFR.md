...
-   If your device has trouble connecting to AWS IoT, open the `aws_clientcredential.h` file, and verify that the configuration variables are properly defined in the file. `TEST_ENDPOINT_NEW_STACK[]` should look like ``<1234567890123>-ats.iot.<us-east-1>.amazonaws.com``.
